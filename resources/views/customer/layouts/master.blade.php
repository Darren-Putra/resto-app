...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('asset/customer/lib/lightbox/css/lightbox.min.css') }}" rel="stylesheet">
        <link href="{{ asset('asset/customer/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">

        <!-- Customized Bootstrap Stylesheet -->
        <link href="{{ asset('asset/customer/css/bootstrap.min.css') }}" rel="stylesheet">

        <!-- Template Stylesheet -->
        <link href="{{ asset('asset/customer/css/style.css') }}" rel="stylesheet">
    </head>
    ...
    <script src="{{ asset('asset/customer/lib/easing/easing.min.js') }}"></script>
    <script src="{{ asset('asset/customer/lib/waypoints/waypoints.min.js') }}"></script>
    <script src="{{ asset('asset/customer/lib/lightbox/js/lightbox.min.js') }}"></script>
    <script src="{{ asset('asset/customer/lib/owlcarousel/owl.carousel.min.js') }}"></script>
